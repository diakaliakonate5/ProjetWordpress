<?php
/*
Plugin Name: WowCarousel for Divi Lite
...
define( 'WDCL_PLUGIN_VERSION', '1.2.0' );
 ...
 * @return void
 */
function appsero_init_tracker_wow_carousel_for_divi_lite() {

	if ( ! class_exists( 'Appsero\Client' ) ) {
		require_once __DIR__ . '/appsero/src/Client.php';
	}

	$client = new Appsero\Client( 'e615c7b1-2afc-4acc-ac26-b6c7ad0619f6', 'Wow Divi Carousel Lite', __FILE__ );
...
appsero_init_tracker_wow_carousel_for_divi_lite();
